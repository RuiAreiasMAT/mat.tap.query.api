...
3. Use Swagger UI.
	...
	- An alternative way to test this API is using Swagger UI that it's embedded in the own implementation of this service. You can check more information about it in the following [Swagger](#swagger) section of this documentation.
